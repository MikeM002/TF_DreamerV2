...
from tensorflow_probability import distributions as tfd #Uso de modelos probabilísticos de TensorFlow

import agent
import common


class Random(common.Module): #Esploración aleatoria
...
class Plan2Explore(common.Module): #Exploración de Plan2Explore, usando actor-critic
...
class ModelLoss(common.Module): #Calcula la pérdida del modelo
